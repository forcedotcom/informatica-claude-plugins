...
- If you'd like to propose a new plugin, or new capability inside the existing `informatica-for-claude-platform/` plugin, describe the problem you want to solve in a [new issue](https://github.com/forcedotcom/informatica-claude-plugins/issues/new) first.
...
**Adding a new plugin** should follow the same shape as `informatica-for-claude-platform/` (see the root [`CLAUDE.md`](CLAUDE.md) for full detail):
